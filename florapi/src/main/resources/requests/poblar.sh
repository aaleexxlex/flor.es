...
### PRODUCTOS (40)
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Rosa Roja", "tipoFlor": "Rosa", "color": "Rojo", "precio": 14.76, "cantidad": 15, "imagen": "/images/rosa.png", "esRamo": false,"ocasion": "San Valentín", "floricultor": {"email": "marta@example.com"}}'
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Tulipán Amarillo", "tipoFlor": "Tulipán", "color": "Amarillo", "precio": 17.07, "cantidad": 5, "imagen": "/images/tulipan.png", "esRamo": false,"ocasion": "Nacimiento", "floricultor": {"email": "marta@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Ramo de Rosas", "tipoFlor": "Ramo", "color": "Rojo", "precio": 42.71, "cantidad": 0, "imagen": "/images/ramoRosas.jpg", "esRamo": true,"ocasion": "San Valentín", "floricultor": {"email": "marta@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Rosa Roja", "tipoFlor": "Rosa", "color": "Rojo", "precio": 15.76, "cantidad": 15, "imagen": "/images/rosa.png", "esRamo": false,"ocasion": "San Valentín", "floricultor": {"email": "luis@example.com"}}'
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Tulipán Amarillo", "tipoFlor": "Tulipán", "color": "Amarillo", "precio": 18.07, "cantidad": 5, "imagen": "/images/tulipan.png", "esRamo": false,"ocasion": "Nacimiento", "floricultor": {"email": "luis@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Ramo de Rosas", "tipoFlor": "Ramo", "color": "Rojo", "precio": 44.71, "cantidad": 0, "imagen": "/images/ramoRosas.jpg", "esRamo": true,"ocasion": "San Valentín", "floricultor": {"email": "luis@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Rosa Roja", "tipoFlor": "Rosa", "color": "Rojo", "precio": 14.76, "cantidad": 15, "imagen": "/images/rosa.png", "esRamo": false,"ocasion": "San Valentín", "floricultor": {"email": "carlos@example.com"}}'
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Tulipán Amarillo", "tipoFlor": "Tulipán", "color": "Amarillo", "precio": 16.07, "cantidad": 5, "imagen": "/images/tulipan.png", "esRamo": false,"ocasion": "Nacimiento", "floricultor": {"email": "carlos@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Ramo de Rosas", "tipoFlor": "Ramo", "color": "Rojo", "precio": 40.71, "cantidad": 0, "imagen": "/images/ramoRosas.jpg", "esRamo": true,"ocasion": "San Valentín", "floricultor": {"email": "carlos@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Rosa Roja", "tipoFlor": "Rosa", "color": "Rojo", "precio": 13.76, "cantidad": 15, "imagen": "/images/rosa.png", "esRamo": false,"ocasion": "San Valentín", "floricultor": {"email": "sofia@example.com"}}'
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Tulipán Amarillo", "tipoFlor": "Tulipán", "color": "Amarillo", "precio": 14.07, "cantidad": 5, "imagen": "/images/tulipan.png", "esRamo": false,"ocasion": "Nacimiento", "floricultor": {"email": "sofia@example.com"}}'
...
curl -s -X POST "$BASE_URL/productos" -H "Content-Type: application/json" -d '{"nombre": "Ramo de Rosas", "tipoFlor": "Ramo", "color": "Rojo", "precio": 42.71, "cantidad": 0, "imagen": "/images/ramoRosas.jpg", "esRamo": true,"ocasion": "San Valentín", "floricultor": {"email": "sofia@example.com"}}'
